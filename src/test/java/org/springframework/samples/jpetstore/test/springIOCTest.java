...
import org.springframework.samples.jpetstore.services.AutowirePetStoreServiceImpl;
...
//		services.getSamename();
		 ...
		 * 自动装配测试
		 */
		AutowirePetStoreServiceImpl autoServices = context.getBean("autowirePetStore",AutowirePetStoreServiceImpl.class);
		autoServices.petToAccountDao();
	}
